...
#define NUM_CONSUMER (2 * NUM_PRODUCER)

#define CHAR_PER_PRODUCER 10
#define CHAR_PER_CONSUMER 5
...
producer (void *arg)
{
  for (int i = 0; i < CHAR_PER_PRODUCER; i++)
    {
...
consumer (void *arg)
{
  for (int i = 0; i < CHAR_PER_CONSUMER; i++)
    {
